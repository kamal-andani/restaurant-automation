		...
		try
		{
		   ...
		   echo "<div class='container'>";
			...
			if(isset($_GET['cat']))
			{
				...
				{
					$stmt = $dbhandler->prepare("SELECT * FROM menuitem where category='dessert'");
				}
				else if($mes=='dinner')
				{
				...
				else if($mes=='bevereges')
					$stmt = $dbhandler->prepare("SELECT * FROM menuitem where category='bevereges'");
				else
