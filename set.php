...
<?php
	...
	if(isset($_SESSION['rec']))
	{
		...
		try{
			...
			//	{
			//		if(is_numeric($_POST['pass'])==false)
			//		{
		...
		//		header("location:setpassword.php?msg=Length is short...Try again");		
				...
				header("location:setpassword.php?msg=Both password must be same");
		   }
	...
	{
		header("location:recover.php?msg=Please provide your credentials");
	}
